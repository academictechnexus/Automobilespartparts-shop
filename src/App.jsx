...
function AppShell() {
  ...
  if (!subStatus.valid && user.role !== 'owner') {
    return (
      <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
        <div className="bg-gray-900 border border-red-500/30 rounded-2xl p-8 max-w-sm w-full text-center">
          ...
          <p className="text-gray-400 text-sm mb-4">{subStatus.reason}. Please contact the shop owner to renew.</p>
          <p className="text-gray-600 text-xs">Contact your admin to activate subscription.</p>
        </div>
      </div>
    );
  }
