...
import { Sidebar, TopBar, MobileBottomNav } from './components/shared/Nav';
...
const PAGES = {
  ...
  stockadjust: StockAdjustment, customers: Customers, suppliers: Suppliers,
  purchases: Purchases, returns: Returns, jobcards: JobCards,
  expenses: Expenses, reports: Reports, analytics: Analytics,
  settings: Settings, admin: AdminPanel, barcodes: BarcodeManager,
};
